...
document.querySelectorAll("[data-view]").forEach(t=>{
    t.addEventListener("click", e=>{
        t.targetEl || (e = e.target.closest(e.target.getAttribute("data-view-target")) || document.querySelector(e.target.getAttribute("data-view-target")),
        t.targetEl = e),
        "fullscreen" == t.getAttribute("data-view") ? t.classList.contains("active") ? t.targetEl.requestFullscreen ? t.targetEl.requestFullscreen() : t.targetEl.webkitRequestFullscreen && t.targetEl.webkitRequestFullscreen() : document.exitFullscreen ? document.exitFullscreen() : document.webkitExitFullscreen && document.webkitExitFullscreen() : (t.targetEl.classList.toggle("content-full-page"),
...
document.querySelectorAll(".nav-toggler").forEach(e=>{
    e.addEventListener("click", ()=>{
        window.innerWidth < 992 || !root.classList.contains("mn--min") && !root.classList.contains("mn--max") ? root.classList.toggle("mn--show") : (root.classList.toggle("mn--min"),
...
document.addEventListener("click", e=>{
    e.target.classList.contains("root") && (root.classList.remove("mn--show"),
    root.classList.contains("sb-stuck") || root.classList.remove("sb--show"))
}
);
...
mainNav && (isMiniNav = root.classList.contains("mn--min"),
...
const popperOptions = {
  ...
  , toggleContent = e=>{
    if (!e.target._mainnav.target.classList.contains("nav-label") || isMiniNav && !(window.innerWidth < 992)) {
        ...
        ["click", "touchend"].forEach(e=>document.addEventListener(e, hideAllMiniNavContent, {
            once: !0
        }))
    }
}
  , buildNav = ()=>{
    ...
    miniNavTogglers.map(t=>{
        ...
        !isMiniNav || window.innerWidth < 992 ? (t.addEventListener("click", toggleContent),
        ["mouseenter", "touchend"].forEach(e=>t.removeEventListener(e, toggleContent)),
        null != t._mainnav.target.popper && (t._mainnav.target.popper.setOptions({
            scroll: !1,
            resize: !1
        }),
        t._mainnav.target.popper.destroy()),
        t._mainnav.target.addEventListener("hide.bs.collapse", bsCollapseHide)) : (miniNavContentsCollapse.map(async e=>e.hide()),
...
if (document.getElementById("_dm-settingsContainer")) {
    ...
    const n = e=>{
        e && (root.classList.remove("mn--min", "mn--max"),
        buildNav())
    }
    ;
    ...
    const o = document.getElementById("dm_colorSchemesContainer")
      ...
      , r = t=>{
        let o = null;
        return [...document.getElementsByTagName("link")].map(e=>e.href.includes(t) ? o = e : null),
    ...
    const y = e=>{
      ...
      , z = (e,o)=>{
        ...
        return e.length <= 0 && (a = "bootstrap" == o ? s : t),
        a
    }
      , A = ()=>{
        if (b++,
    ...
    p.map(c=>{
        c.addEventListener("click", t=>{
            if (!c.classList.contains("active")) {
                ...
                if (b = 0,
                v = 1,
                c.getAttribute("data-single") || (e = z(c.getAttribute("data-dir"), "bootstrap")),
                t != e) {
                    v++,
    ...
    document.getElementById("_dm-sidebarsScrollbarCheckbox").addEventListener("change", async e=>{
        await E(),
        e.target.checked ? c = OverlayScrollbars(document.querySelectorAll(".scrollable-content"), D) : c.map(e=>e.destroy())
    }
    )
}
